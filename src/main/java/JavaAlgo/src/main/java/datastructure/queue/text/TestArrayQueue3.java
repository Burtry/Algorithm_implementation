package JavaAlgo.src.main.java.datastructure.queue.text;

import JavaAlgo.src.main.java.datastructure.queue.ArrayQueue3;
...
/*    @Test
    public void boundary() {
        ...
        ((ArrayQueue3<Integer>) queue).head = 2147483640;
        ((ArrayQueue3<Integer>) queue).tail = queue.head;
